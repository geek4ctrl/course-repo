...
describe('military time validator', () => {
    ...
    it('should have numbers between 0 and 23 for ending hours', () => {
        // Arrange
    ...
    it('should have numbers between 0 and 59 for starting minutes', () => {
        // Arrange
    ...
    it('should have numbers between 0 and 59 for ending minutes', () => {
        // Arrange
    ...
    it('should have numbers in starting hours less than numbers in ending hours', () => {
        // Arrange
